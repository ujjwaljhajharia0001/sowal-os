  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      sender: "sowal",
      text: "SOWAL OS fully synchronized, Ujjwal. Soil Science, Colloids & CEC ya Agronomy me kis topic ka viva test lena hai?",
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (res.ok && data.display) {
        ...
        setMessages((prev) => [
          ...prev,
          { id: Date.now().toString(), sender: "sowal", text: data.display || "Response fetch nahi ho paya.", engine: "Error" }
        ]);
      }
    } catch {
      setLoading(false);
